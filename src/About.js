    ...
    return (
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="mb-4">
              <h3 className="text-white text-center"><u>Our Story</u></h3>
            ...
            <div className="mb-4">
              <h3 className="text-white text-center"><u>Our Mission</u></h3>
              <p className="text-white text-center">
            ...
            <div className="mb-4">
              <h3 className="text-white text-center"><u>What Sets Us Apart</u></h3>
              <p className="text-white text-center">
            ...
            <div>
              <h3 className="text-white text-center"><u>Join Us</u></h3>
              <p className="text-white text-center">
